...
const strictRecommendationResponseSchema = z.object({
  ...
  recommendedServiceType: z.enum(["web", "mobile-web", "software"]),
...
export const recommendationJsonShape = `{
  ...
  "recommendedServiceType": "web | mobile-web | software 중 하나",
...
export const recommendationOutputJsonSchema = {
  ...
  properties: {
    ...
    recommendedServiceType: { type: "string", enum: ["web", "mobile-web", "software"] },
